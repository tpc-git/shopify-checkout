          ...
          <div className="set-grid">
            <div className="full">
              <p className="field-note" style={{ marginTop: 0 }}>
                After-hours SMS copy is generated by OpenAI from the customer&apos;s name and cart
                products (OPENAI_API_KEY). Quo credentials are configured via QUO_API_KEY and
                QUO_FROM_NUMBER. If SMS_OVERRIDE_TO is set, qualifying SMS is redirected to that
                number (checkout phone still required).
              </p>
            </div>
          </div>
